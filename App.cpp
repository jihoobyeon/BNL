...
static const char* s_applicationName  = "MyConsole Runtime";
static const char* s_applicationClass = "Runtime";
...
namespace
{
    ...
    void InitBabylon(Window window, int width, int height, int argc, const char* const* argv)
    {
        ...
        if (scripts.empty())
        {
            loader.LoadScript(moduleRootUrl + "/Scripts/run.js");
        }
        else
        {
            ...
            loader.LoadScript(moduleRootUrl + "/Scripts/runner.js");
        }
    }
